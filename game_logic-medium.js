...
(function () {
  ...
  const REEL_TOP = 150;
  const BACK_CARD_WIDTH = 250;
  const BACK_CARD_HEIGHT = 375;
  const REEL_GAP = 8;
  ...
  function createUI(container) {
    ...
    topLogo.style.top = "20px";
    topLogo.style.left = "20px";
    ...
    titleText.innerText = "Gay Ejypti Spades";
    titleText.style.position = "absolute";
    titleText.style.top = "45px";
    titleText.style.left = "140px";
    ...
    styleTag.textContent = `
      ...
      .favoriteHeart { width:56px; height:56px; }
      .favoriteCardsRow { display:flex; gap:8px; }
      .favoriteCardThumb { width:48px; height:72px; border-radius:4px; }
    ...
    leftTorch.style.left = '20px';
    leftTorch.style.bottom = '20px';
    ...
    rightTorch.style.left = '670px';
    rightTorch.style.bottom = '20px';
    ...
    fHeart.alt = 'heart';
    fHeart.style.width = '154px';
    fHeart.style.height = '103px';
